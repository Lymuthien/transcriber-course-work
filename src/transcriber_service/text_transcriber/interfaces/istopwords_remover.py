...
Classes:
--------
    - IStopwordsRemover: Abstract interface for removing stopwords from text.
"""
...
class IStopwordsRemover(ABC):
    ...
    def remove_stopwords(self, text: str, remove_swear_words: bool = True) -> str:
        ...
        -----------
            ...
            remove_swear_words (bool): Whether to also remove swear words from the text.
    ...
    def remove_words(self, text: str, removing_words: tuple | list) -> str:
        ...
        -----------
            ...
            removing_words (tuple | list): A list or tuple of words to remove from the text.

        Returns:
        --------
            str: The cleaned text with the specified words removed.
        """
        pass
