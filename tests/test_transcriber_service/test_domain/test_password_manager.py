...
from transcriber_service.infrastructure.services.password_manager import PasswordManager
...
class TestPasswordManager(unittest.TestCase):
    ...
    def test_create_password_returns_different_passwords(self):
        self.assertNotEqual(
            PasswordManager.create_password(), PasswordManager.create_password()
        )
