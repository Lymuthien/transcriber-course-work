...
from transcriber_service.interfaces.istopwords_remover import IStopwordsRemover
from transcriber_service.interfaces.itranscribe_processor import ITranscribeProcessor
