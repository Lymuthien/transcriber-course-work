...
class TestLocalStorageRepository(unittest.TestCase):
    ...
    def test_get_by_id(self):
        ...
        self.assertEqual(
            self.local_storage_repository.get_by_id(mock_storage.id), mock_storage
        )
    ...
    def test_get_by_user(self):
        ...
        self.assertEqual(
            self.local_storage_repository.get_by_user(mock_storage.user_id),
            mock_storage,
        )
    ...
    def test_get_all_records(self):
        ...
        self.assertEqual(
            self.local_storage_repository.get_all_records(mock_storage.id),
            mock_storage.audio_record_ids,
        )
